# WebFS
WebFS is a remote filesystem web service. Allows most common operations like create, list, upload, and download files with basic authentication and simple role permission.
